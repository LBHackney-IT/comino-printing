...
{
    class DiscExeLtrToHospCareHomeOrHostel : ILetterParser
    {
        public LetterTemplate Execute(string html)
        {
            ...
            var newPageText = mainBody.SelectNodes("p").ToList().FirstOrDefault(p => p.InnerText.Contains("Disc/Exe-Ltr to Hosp,Care Home or Hostel"));
